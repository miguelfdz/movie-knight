...
<body>
    ...
    <?php
        try {
          ...
          $sql = "SELECT poster_pelicula FROM peliculas WHERE id_pelicula LIKE '%$busqueda%' or nombre LIKE '%$busqueda%' or genero LIKE '%$busqueda%' or protegonistas LIKE '%$busqueda%' or director LIKE '%$busqueda%'";
    ...
    <main class="seccion contenedor">
        <h2 class="fw-300 centrar-texto">Resultados con "<?php echo $busqueda; ?>"</h2>
