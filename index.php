...
<body>
    ...
    <?php
        try {
          ...
          $sql = "SELECT poster_pelicula FROM peliculas";
    ...
    <main class="seccion contenedor">
        <h2 class="fw-300 centrar-texto">Películas Disponibles</h2>
                      ...
                      foreach ($posters_peliculas as $poster => $value) {?>
                          <div class="anuncio">
                            ...
                            <form action="pelicula.php?poster=<?php echo $value ?>" method="post" enctype="multipart/form-data" id="MyUploadForm">
                                  ...
                                  <input class="boton-verde" type="submit" value="Ver información">
                              </form>
                          </div>
                    <?php  }?>
                <?php } ?>
