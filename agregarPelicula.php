...
<body>
    ...
    <main class="seccion contenedor">
        <h2 class="fw-300 centrar-texto">Agregar Película</h2>

        <form action="peliculaAgregada.php" method="post">
          <fieldset>
            <div>
              ...
              <input type="url" name="poster" placeholder="Link de poster de la película" >

              <label for="genero">Género: </label>
              <input type="text" name="genero" placeholder="Terror/Accion/Amor" >

              <label for="director">Director: </label>
              <input type="text" name="director" placeholder="Nombre del director" >

              <label for="duracion">Duración: </label>
              <input id="duracion" type="number" name="duracion" min="0" max="99999" placeholder="Tiempo en minutos" >
            </div>

            <div>
              <label for="protagonistas">Protagonistas: </label>
              <textarea  name="protagonistas" placeholder="Nombres de los protagonistas separados por una coma (  ,  )"></textarea>

              <label for="sinopsis">Sinopsis: </label>
              <textarea  name="sinopsis" placeholder="Breve Sinopsis de la película"></textarea>
            </div>

            </fieldset>

            <input onclick="verificarDuracion()" type="submit" value="Agregar Película" class="boton boton-verde">
        </form>
